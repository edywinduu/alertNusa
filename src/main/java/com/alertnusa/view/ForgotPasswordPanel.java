...
public class ForgotPasswordPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        welcomeLabel.setText("FORGOT PASSWORD");
        ...
        welcomeLabel3.setText("New Password");
        ...
        welcomeLabel5.setText("<html>Already Remember? <span style=\"text-decoration: underline;\">Sign In</span></html>");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(welcomeLabel5, javax.swing.GroupLayout.Alignment.TRAILING)
        );
    ...
    private void jButton9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton9MouseClicked
        ...
        if (!newPassIn.equals(confirmNewPassIn)) {
            alertLabel.setText("Password baru dan konfirmasi tidak sama!");
            javax.swing.Timer timer = new javax.swing.Timer(2000, e -> alertLabel.setText(""));
            timer.setRepeats(false);
            timer.start();
            return;
        ...
        if (userSession.resetPassword(userIn, emailIn, newPassIn)) {
            alertLabel.setForeground(new java.awt.Color(153,153,255));
            alertLabel.setText("Reset Password Berhasil! Silakan Login kembali.");
            javax.swing.Timer timer = new javax.swing.Timer(2000, e -> alertLabel.setText(""));
            timer.setRepeats(false);
            timer.start();
        } else {
